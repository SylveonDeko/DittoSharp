...
namespace Ditto.Common.ModuleBases;

/// <summary>
///     Base class for slash command modules in Ditto.
/// </summary>
...
/// <summary>
///     Base class for generic slash command modules in Ditto.
/// </summary>
public abstract class DittoSlashModuleBase<TService> : DittoSlashCommandModule
{
    /// <summary>
...
/// <summary>
///     Base class for generic slash submodule in Ditto.
/// </summary>
public abstract class DittoSlashSubmodule : DittoSlashCommandModule;

/// <summary>
///     Base class for generic slash submodule with a service in Ditto.
/// </summary>
public abstract class DittoSlashSubmodule<TService> : DittoSlashModuleBase<TService>;