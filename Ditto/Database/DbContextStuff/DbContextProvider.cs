...
{
    private readonly IDbContextFactory<DittoContext> _contextFactory;
    ...
    ///     field.
    /// </remarks>
    public DbContextProvider(IDbContextFactory<DittoContext> contextFactory)
    {
    ...
    ///     The task result contains a new instance of <see cref="DittoContext" />.
    /// </returns>
    /// <remarks>
    ...
    /// </remarks>
    public async Task<DittoContext> GetContextAsync()
    {
