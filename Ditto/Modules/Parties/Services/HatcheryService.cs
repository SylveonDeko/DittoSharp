...
namespace Ditto.Modules.Parties.Services
{
    public class HatcheryService(DittoContext db, DiscordShardedClient client) : INService
    {
        ...
        {
            if (_pagedResults.TryGetValue(userId, out var result))
            {
        ...
        public Task UpdatePagedResult(ulong userId, int newPage)
        {
            if (_pagedResults.TryGetValue(userId, out var result))
            {
                _pagedResults[userId] = (result.Pages, newPage);
            }
        ...
        public async Task<EmbedBuilder> GetHatcheryViewEmbed(ulong userId, short group)
        {
            ...
            foreach (var (slotNumber, eggName, pokemonNumber, stepCounter) in slotData)
            {
                ...
                {
                    description += $"**__Slot {slotNumber}__** - **Steps:** `{stepCounter}`\n`{eggName} [{pokemonNumber}]`\n\n";
                }
            }
            ...
            embed.AddField("Max Egg Slots", maxMsg, inline: false);
        ...
        /// </summary>
        public async Task<(bool Success, string Message)> AddEggToHatchery(ulong userId, int eggIndex, short group, int slot)
        {
            try
            {
                // Validate parameters
                if (group < 1 || group > 3 || slot < 1 || slot > 10)
                {
                    return (false, "Invalid group or slot number.");
                }
                ...
                if (slot == 7 && patreonTier < PatreonTier.Gold)
                {
                    return (false, "You must be a Gold or Crystal Patreon to add eggs to slot 7.");
                }

                if (slot >= 8 && patreonTier < PatreonTier.Crystal)
                {
                ...
                if (eggIndex <= 0 || eggIndex > user.Pokemon.Length)
                {
                ...
                if (egg == null)
                {
                    return (false, "The provided ID is not a valid Egg or doesn't exist.");
                }
                ...
                if (hatcheriesWithEgg)
                {
                    return (false, "This Egg is already in a hatchery slot.");
                }
                ...
                if (isSlotOccupied)
                {
                    return (false, $"Slot {slot} in group {group} is already occupied.");
                }
            ...
            {
                // Log the error
                var errorChannel = client.GetChannel(1004311971853779005) as SocketTextChannel;
        ...
        public async Task<(bool Success, string Message)> RemoveEggFromHatchery(ulong userId, int group, int slot)
        {
            try
            {
                ...
                if (hatchery == null)
                {
                    return (false, $"You don't have a hatchery in group {group}.");
                }
                ...
                if (eggId == null)
                {
                    return (false, $"Slot {slot} in group {group} is empty.");
                }
        ...
        /// </summary>
        public async Task<Dictionary<int, List<int>>> SetMultipleEggs(ulong userId, short group, int? slot1, int? slot2, int? slot3,
            int? slot4, int? slot5, int? slot6, int? slot7, int? slot8, int? slot9, int? slot10)
        {
            var slotArray = new int?[] { slot1, slot2, slot3, slot4, slot5, slot6, slot7, slot8, slot9, slot10 };
            ...
            for (var slotIndex = 0; slotIndex < slotArray.Length; slotIndex++)
            {
                ...
                if (eggIndex.HasValue)
                {
                    ...
                    if (result.Success)
                    {
                        if (!addedEggs.ContainsKey(group))
                        {
                            addedEggs[group] = new List<int>();
                        }
        ...
        public async Task<(bool Success, string Message)> SwapEggs(ulong userId, ulong egg1Id, ulong egg2Id)
        {
            try
            {
                ...
                {
                    if (hatchery.Slot1 == egg1Id) { hatchery1 = hatchery; egg1Slot = 1; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot2 == egg1Id) { hatchery1 = hatchery; egg1Slot = 2; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot3 == egg1Id) { hatchery1 = hatchery; egg1Slot = 3; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot4 == egg1Id) { hatchery1 = hatchery; egg1Slot = 4; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot5 == egg1Id) { hatchery1 = hatchery; egg1Slot = 5; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot6 == egg1Id) { hatchery1 = hatchery; egg1Slot = 6; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot7 == egg1Id) { hatchery1 = hatchery; egg1Slot = 7; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot8 == egg1Id) { hatchery1 = hatchery; egg1Slot = 8; egg1Group = hatchery.Group; break; }
                    if (hatchery.Slot9 == egg1Id) { hatchery1 = hatchery; egg1Slot = 9; egg1Group = hatchery.Group; break; }

                    if (hatchery.Slot10 != egg1Id) continue;
                    hatchery1 = hatchery; egg1Slot = 10; egg1Group = hatchery.Group; break;
                }

                // Find the second egg
                foreach (var hatchery in hatcheries)
                {
                    if (hatchery.Slot1 == egg2Id) { hatchery2 = hatchery; egg2Slot = 1; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot2 == egg2Id) { hatchery2 = hatchery; egg2Slot = 2; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot3 == egg2Id) { hatchery2 = hatchery; egg2Slot = 3; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot4 == egg2Id) { hatchery2 = hatchery; egg2Slot = 4; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot5 == egg2Id) { hatchery2 = hatchery; egg2Slot = 5; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot6 == egg2Id) { hatchery2 = hatchery; egg2Slot = 6; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot7 == egg2Id) { hatchery2 = hatchery; egg2Slot = 7; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot8 == egg2Id) { hatchery2 = hatchery; egg2Slot = 8; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot9 == egg2Id) { hatchery2 = hatchery; egg2Slot = 9; egg2Group = hatchery.Group; break; }
                    if (hatchery.Slot10 == egg2Id) { hatchery2 = hatchery; egg2Slot = 10; egg2Group = hatchery.Group; break; }
                }
                ...
                switch (egg1Slot)
                {
                    case 1: temp = hatchery1.Slot1; hatchery1.Slot1 = null; break;
                    case 2: temp = hatchery1.Slot2; hatchery1.Slot2 = null; break;
                    case 3: temp = hatchery1.Slot3; hatchery1.Slot3 = null; break;
                    case 4: temp = hatchery1.Slot4; hatchery1.Slot4 = null; break;
                    case 5: temp = hatchery1.Slot5; hatchery1.Slot5 = null; break;
                    case 6: temp = hatchery1.Slot6; hatchery1.Slot6 = null; break;
                    case 7: temp = hatchery1.Slot7; hatchery1.Slot7 = null; break;
                    case 8: temp = hatchery1.Slot8; hatchery1.Slot8 = null; break;
                    case 9: temp = hatchery1.Slot9; hatchery1.Slot9 = null; break;
                    case 10: temp = hatchery1.Slot10; hatchery1.Slot10 = null; break;
                }

                ulong? temp2 = null;
                switch (egg2Slot)
                {
                    case 1: temp2 = hatchery2.Slot1; hatchery2.Slot1 = temp; break;
                    case 2: temp2 = hatchery2.Slot2; hatchery2.Slot2 = temp; break;
                    case 3: temp2 = hatchery2.Slot3; hatchery2.Slot3 = temp; break;
                    case 4: temp2 = hatchery2.Slot4; hatchery2.Slot4 = temp; break;
                    case 5: temp2 = hatchery2.Slot5; hatchery2.Slot5 = temp; break;
                    case 6: temp2 = hatchery2.Slot6; hatchery2.Slot6 = temp; break;
                    case 7: temp2 = hatchery2.Slot7; hatchery2.Slot7 = temp; break;
                    case 8: temp2 = hatchery2.Slot8; hatchery2.Slot8 = temp; break;
                    case 9: temp2 = hatchery2.Slot9; hatchery2.Slot9 = temp; break;
                    case 10: temp2 = hatchery2.Slot10; hatchery2.Slot10 = temp; break;
                }
        ...
        /// </summary>
        private async Task<(int AvailableSlots, int MaxSlots, List<(int SlotNumber, string EggName, int? PokemonNumber, int StepCounter)>)> GetHatcheryData(ulong userId, short group, PatreonTier patreonTier)
        {
            ...
            {
                return (0, maxSlots, new List<(int, string, int?, int)>());
            }
            ...
            if (patreonTier >= PatreonTier.Gold)
            {
                await ProcessSlot(7, hatchery.Slot7);
            }
