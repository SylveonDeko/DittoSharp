...
namespace Ditto.Modules.Parties
{
    ...
    public class HatcheryModule(HatcheryService hatcheryService) : DittoSlashModuleBase<HatcheryService>
    {
        ...
        public async Task ViewHatchery()
        {
            ...
            var components = new ComponentBuilder()
                .WithButton(customId: "hatchery:prev", emote: new Emoji("<a:leftarrow:1061558390809174066>"), style: ButtonStyle.Primary)
                .WithButton(customId: "hatchery:next", emote: new Emoji("<a:rightarrow:1061557943398580275>"), style: ButtonStyle.Primary);
        ...
        public async Task SetEggs(
            [Choice("1", 1), Choice("2", 2), Choice("3", 3)] short group,
            int? slot1 = null,
            int? slot2 = null,
            int? slot3 = null,
            int? slot4 = null,
        ...
        public async Task RemoveEgg(
            [Choice("1", 1), Choice("2", 2), Choice("3", 3)] int group,
            [Choice("1", 1), Choice("2", 2), Choice("3", 3), Choice("4", 4), Choice("5", 5),
             Choice("6", 6), Choice("7", 7), Choice("8", 8), Choice("9", 9), Choice("10", 10)] int slot)
        {
    ...
    public class HatcheryInteractionModule(HatcheryService hatcheryService) : DittoSlashModuleBase<HatcheryService>
    {
        ...
        public async Task HandlePrevPage()
        {
            ...
            {
                props.Embed = pages[newPage].Build();
            });
        }
