...
/// <summary>
///     Provides autocomplete functionality for all of user's Pokemon.
///     Unlike PokemonAutocompleteHandler, this includes all Pokemon regardless of trade restrictions.
///     Used for forms, items, and other non-trading commands.
/// </summary>
public class AllPokemonAutocompleteHandler : AutocompleteHandler
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="AllPokemonAutocompleteHandler" /> class.
    /// </summary>
    /// <param name="dbProvider">The database connection provider.</param>
    public AllPokemonAutocompleteHandler(LinqToDbConnectionProvider dbProvider)
    {
    ...
    private static string CreateDisplayName(string pokemonName, string nickname, ulong position, int level, bool? shiny, bool? radiant, bool? favorite)
    {
