...
public class Gym
{
    ...
    /// </summary>
    [Column("cooldown")] public ulong? Cooldown { get; set; }
    ...
    /// </summary>
    [Column("theblazingbowl")] public bool? TheBlazingBowl { get; set; }
    ...
    /// </summary>
    [Column("theunderwaterarena")] public bool? TheUnderwaterArena { get; set; }
    ...
    /// </summary>
    [Column("fieldofflowers")] public bool? FieldOfFlowers { get; set; }
    ...
    /// </summary>
    [Column("prismpalace")] public bool? PrismPalace { get; set; }
    ...
    /// </summary>
    [Column("thebasicbungalow")] public bool? TheBasicBungalow { get; set; }
    ...
    /// </summary>
    [Column("starterstation")] public bool? StarterStation { get; set; }
    ...
    /// </summary>
    [Column("floatingisland")] public bool? FloatingIsland { get; set; }
    ...
    /// </summary>
    [Column("stablessstadium")] public bool? StablessStadium { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether the user has defeated the Triangular Tower gym.
    /// </summary>
    [Column("triangulartower")] public bool? TriangularTower { get; set; }
    ...
    /// </summary>
    [Column("monotypemarket")] public bool? MonotypeMarket { get; set; }
    ...
    /// </summary>
    [Column("generationalgallery")] public bool? GenerationalGallery { get; set; }
    ...
    /// </summary>
    [Column("bansaucearena")] public bool? BansauceArena { get; set; }
    ...
    /// </summary>
    [Column("physicalfortress")] public bool? PhysicalFortress { get; set; }
    ...
    /// </summary>
    [Column("specialshack")] public bool? SpecialShack { get; set; }
    ...
    /// </summary>
    [Column("reversedimension")] public bool? ReverseDimension { get; set; }
    ...
    /// </summary>
    [Column("elite4")] public bool? Elite4 { get; set; }
    ...
    /// </summary>
    [Column("theblazingbowl_ts")] public ulong? TheBlazingBowlTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated The Underwater Arena gym.
    /// </summary>
    [Column("theunderwaterarena_ts")] public ulong? TheUnderwaterArenaTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Field of Flowers gym.
    /// </summary>
    [Column("fieldofflowers_ts")] public ulong? FieldOfFlowersTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Prism Palace gym.
    /// </summary>
    [Column("prismpalace_ts")] public ulong? PrismPalaceTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated The Basic Bungalow gym.
    /// </summary>
    [Column("thebasicbungalow_ts")] public ulong? TheBasicBungalowTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Starter Station gym.
    /// </summary>
    [Column("starterstation_ts")] public ulong? StarterStationTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Floating Island gym.
    /// </summary>
    [Column("floatingisland_ts")] public ulong? FloatingIslandTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Stabless Stadium gym.
    /// </summary>
    [Column("stablessstadium_ts")] public ulong? StablessStadiumTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Triangular Tower gym.
    /// </summary>
    [Column("triangulartower_ts")] public ulong? TriangularTowerTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Monotype Market gym.
    /// </summary>
    [Column("monotypemarket_ts")] public ulong? MonotypeMarketTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Generational Gallery gym.
    /// </summary>
    [Column("generationalgallery_ts")] public ulong? GenerationalGalleryTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Bansauce Arena gym.
    /// </summary>
    [Column("bansaucearena_ts")] public ulong? BansauceArenaTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Physical Fortress gym.
    /// </summary>
    [Column("physicalfortress_ts")] public ulong? PhysicalFortressTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Special Shack gym.
    /// </summary>
    [Column("specialshack_ts")] public ulong? SpecialShackTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Reverse Dimension gym.
    /// </summary>
    [Column("reversedimension_ts")] public ulong? ReverseDimensionTimestamp { get; set; }

    /// <summary>
    /// Gets or sets the timestamp when the user defeated the Elite Four.
    /// </summary>
    [Column("elite4_ts")] public ulong? Elite4Timestamp { get; set; }
