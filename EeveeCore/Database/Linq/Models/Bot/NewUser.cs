...
public class NewUser
{
    ...
    /// </summary>
    [Column("task1", DataType = LinqToDB.DataType.Json)]
    ...
    /// </summary>
    [Column("task2", DataType = LinqToDB.DataType.Json)]
    ...
    /// </summary>
    [Column("task3", DataType = LinqToDB.DataType.Json)]
    ...
    /// </summary>
    [Column("task4", DataType = LinqToDB.DataType.Json)]
    ...
    /// </summary>
    [Column("task5", DataType = LinqToDB.DataType.Json)]
    ...
    /// </summary>
    [Column("task6", DataType = LinqToDB.DataType.Json)]
