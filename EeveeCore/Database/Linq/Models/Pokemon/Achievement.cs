...
public class Achievement
{
    ...
    /// </summary>
    [Column("duel_party_loses")]
    public int DuelPartyLoses { get; set; }

    /// <summary>
    ///     Gets or sets the total experience points earned from duels.
    /// </summary>
    [Column("duel_total_xp")]
    public float DuelTotalXp { get; set; }
    ...
    /// </summary>
    [Column("pokemon_released_ivtotal")]
    ...
    /// </summary>
    [Column("easter_completed")]
    public short EasterCompleted { get; set; }
